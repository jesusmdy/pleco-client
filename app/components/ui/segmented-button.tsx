...
export function SegmentedButtonItem({
  ...
  return (
    <button
      ...
      title={title}
      className={cn(
        "flex items-center justify-center gap-2 px-3 h-9 rounded-xl text-[13px] font-bold transition-all duration-200 select-none active:scale-95 min-w-[36px] border border-transparent",
        active
